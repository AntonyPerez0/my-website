...
const config = {
  ...
  url: 'https://antonyperez0.github.io',
  ...
  organizationName: 'AntonyPerez0', // GitHub org/user name (update if different).
  projectName: 'my-website', // Repo name (update if different).
